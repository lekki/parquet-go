...
import (
	...
	"github.com/lekki/parquet-go/ParquetType"
	"github.com/lekki/parquet-go/parquet"
)
...
func TestCmp(t *testing.T) {
	cases := []struct {
		...
		{"int96 1", string(ParquetType.StrIntToBinary("2147483648", "LittleEndian", 12, true)),
			string(ParquetType.StrIntToBinary("2147483647", "LittleEndian", 12, true)), parquet.TypePtr(parquet.Type_INT96), nil, false},
		{"int96 2", string(ParquetType.StrIntToBinary("-2147483648", "LittleEndian", 12, true)),
			string(ParquetType.StrIntToBinary("-2147483647", "LittleEndian", 12, true)), parquet.TypePtr(parquet.Type_INT96), nil, true},
		...
		{"interval 1", string(ParquetType.StrIntToBinary("12345", "LittleEndian", 12, false)),
			string(ParquetType.StrIntToBinary("123456", "LittleEndian", 12, false)),
			parquet.TypePtr(parquet.Type_FIXED_LEN_BYTE_ARRAY), parquet.ConvertedTypePtr(parquet.ConvertedType_INTERVAL), true},
		{"interval 2", string(ParquetType.StrIntToBinary("123457", "LittleEndian", 12, false)),
			string(ParquetType.StrIntToBinary("123456", "LittleEndian", 12, false)),
		...
		{"decimal 3", string(ParquetType.StrIntToBinary("12345", "BigEndian", 0, true)),
			string(ParquetType.StrIntToBinary("12346", "BigEndian", 0, true)),
			parquet.TypePtr(parquet.Type_FIXED_LEN_BYTE_ARRAY), parquet.ConvertedTypePtr(parquet.ConvertedType_DECIMAL), true},
		{"decimal 4", string(ParquetType.StrIntToBinary("-12345", "BigEndian", 0, true)),
			string(ParquetType.StrIntToBinary("-12346", "BigEndian", 0, true)),
			parquet.TypePtr(parquet.Type_FIXED_LEN_BYTE_ARRAY), parquet.ConvertedTypePtr(parquet.ConvertedType_DECIMAL), false},

		{"decimal 5", string(ParquetType.StrIntToBinary("12345", "BigEndian", 0, true)),
			string(ParquetType.StrIntToBinary("12346", "BigEndian", 0, true)),
			parquet.TypePtr(parquet.Type_BYTE_ARRAY), parquet.ConvertedTypePtr(parquet.ConvertedType_DECIMAL), true},
		{"decimal 6", string(ParquetType.StrIntToBinary("-12345", "BigEndian", 0, true)),
			string(ParquetType.StrIntToBinary("-12346", "BigEndian", 0, true)),
